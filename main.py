...
class Warrior(Character):
    ...
    def __init__(self, w_name: str) -> None:
        super().__init__(w_name)        
...
class Healer (Character):
    ...
    def __init__(self, h_name: str) -> None:
        super().__init__(h_name)
...
def start_training(character: Character) -> str:
    ...
    command_classes = {'attack': character.attack, 
    ...
    while cmd != 'skip':
        ...
        if cmd in command_classes.keys():
            print(command_classes[cmd]())
        else:    
